package com.example.hp.authapp.Login;
...
import com.example.hp.authapp.Login.Utils.FirebaseMethods;
                    ...
                    myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (firebaseMethods.checkIfUsernameExists(email, dataSnapshot)) {
                                ...
                                Log.d(TAG, "OnDataChange: email already exists. Appending random string to name." +append);
                            }
